...
const blogData: (Blog & { quote?: string; quote_en?: string })[] = [
  ...
  },
  {
    ...
    content: [
      "Chaque métier est **exigeant**. Pression sur les résultats, complexité relationnelle, enjeux multiples...<br><br>Parce que chacun, à un moment ou à un autre, peut se retrouver face à des situations où il devient difficile d'y voir clair, convaincre, trancher, gérer une relation...",
